...
def crear_interfaz(logica_cola):
    ...
    def manejar_encolar():
        ...
        if elemento: 
            ...
            messagebox.showwarning("Entrada vacía. Por favor ingrese un elemento")
    ...
    def manejar_tamano(): 
        ...
        messagebox.showinfo("Tamano: ", f"El tamaño de la cola es: {tam}")

    def manejar_mostrar(): 
        cola_actual = logica_cola["Mostrar cola"](cola)
    ...
    tk.Button(ventana, text="Frente", command=manejar_frente).pack(pady=5)
